    ...
    <footer className="bg-construction-dark text-white">
      <div className="section-container py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed">
              ...
              and InfraCons for construction & interior services. TrustSEAL verified with moral business policies 
          ...
          >
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li className="flex items-center">
                ...
                <span>Contact: Lokesh (Manager)</span>
              </li>
              <li className="flex items-center">
                <svg className="w-5 h-5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-400">
          <p className="text-sm">
            © {currentYear} Alphacaps.in. All rights reserved. | 
